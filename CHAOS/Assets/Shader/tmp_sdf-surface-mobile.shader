			...
			Program "fp" {
				SubProgram "d3d9 " {
					...
					//
					    ...
					    add r0.w, -r1.w, c15.x
					    add r0.w, r0.w, -v6.x
					    mad_pp r0.w, r0.w, v6.y, c15.x
					    mad_sat_pp r1.x, r0.y, c15.x, r0.w
					    mad_pp r0.y, r0.y, -c15.x, r0.w
					    mul_pp r0.z, r0.z, r1.x
					    mov r1.y, c0.y
					    mad r2.x, c10.x, r1.y, v1.x
					    mad r2.y, c11.x, r1.y, v1.y
					    texld r2, r2, s1
					    ...
					    mul r0.x, r0.x, c9.x
					    mul_pp r0.z, r0.x, v6.y
					    mad_pp r0.x, r0.x, v6.y, c15.y
					    rcp r0.x, r0.x
					    ...
					    mov_pp oC0.w, r1.w
					    mul_pp r1.xyz, r0, c5
					    mad r2.xw, v2.z, c17.xyzy, c17.yyzx
					    mov r2.y, v3.z
					    mov r2.z, v4.z
					    dp4_pp r3.x, c2, r2
					    dp4_pp r3.y, c3, r2
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat5.xz = u_xlat5.xy * vs_TEXCOORD5.yy;
					    ...
					    u_xlat10_3 = texture(_FaceTex, u_xlat7.xy);
					    u_xlat1 = u_xlat1 * u_xlat10_3;
					    u_xlat7.xy = vec2(_OutlineUVSpeedX, _OutlineUVSpeedY) * _Time.yy + vs_TEXCOORD1.xy;
					    u_xlat10_3 = texture(_OutlineTex, u_xlat7.xy);
					    u_xlat7.xyz = u_xlat10_3.xyz * _OutlineColor.xyz;
					    u_xlat3.w = u_xlat2.x * u_xlat10_3.w;
					    u_xlat2.x = (-u_xlat5.x) * 0.5 + u_xlat0.x;
					    u_xlat15 = u_xlat5.z * 0.5 + u_xlat2.x;
					    u_xlat10 = u_xlat5.y * vs_TEXCOORD5.y + 1.0;
