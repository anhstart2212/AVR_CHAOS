			...
			Program "vp" {
				...
				SubProgram "d3d9 " {
					...
					//
					    ...
					    vs_3_0
					    def c40, 0.5, -0.5, -2e+010, 2e+010
					    def c41, 0, 1.5, 1, 0.25
					    def c42, 2, 0, 0, 0
					    dcl_position v0
					    dcl_normal v1
					    dcl_color v2
					    ...
					    mul r1.z, r1.x, c41.y
					    mul r1.y, r1.y, r1_abs.z
					    mad r2.z, r1.x, c41.y, -r1.y
					    mad r0.w, r0_abs.w, r2.z, r1.y
					    mad r0.w, r1.x, -c41.y, r0.w
					    abs r1.x, c7.w
					    sge r1.x, -r1.x, r1.x
					    mad r0.w, r1.x, r0.w, r1.z
					    mov r1.x, c27.x
					    mul r1.y, r1.x, c18.x
					    mad r1.y, r1.y, r0.w, c41.z
					    rcp r1.y, r1.y
					    mul r3.x, r0.w, r1.y
					    mul r1.x, r1.x, c20.x
					    mul r1.x, r1.x, c40.x
					    ...
					    mov r4.w, c19.w
					    mad r5, v2.xyzx, c41.zzzx, c41.xxxz
					    mul r6, r5, c16
					    mul r5.xyz, r6.w, r6
					    mov r7.xyz, -r5
					    mov o1.xyz, r5
					    ...
					    mov r5.x, c25.x
					    add r1.z, -r5.x, c26.x
					    mad r1.y, r1.y, r1.z, c25.x
					    mad r1.y, r1.y, r1.w, c17.x
					    mul r1.y, r1.y, c27.x
					    mad r1.y, r1.y, -c40.x, c40.x
					    mad r1.z, r1.y, r0.w, c40.y
					    mad r3.w, r1.y, r3.x, c40.y
					    mul r1.y, r4.x, c23.x
					    mul r1.y, r1.y, c40.x
					    mad o7.y, r1.y, -r0.w, r1.z
					    mov o7.x, r0.w
					    mov r1.z, c40.z
					    max r5, r1.z, c31
					    min r5, r5, c40.w
					    add r1.yz, r0.xxyw, -r5.xxyw
					    mad r0.xy, r0, c42.x, -r5
					    add o5.xy, -r5.zwzw, r0
					    add r0.xy, -r5, r5.zwzw
					    rcp r2.z, r0.x
					    rcp r2.w, r0.y
					    mul o3.zw, r1.xyyz, r2
					    mad o4.y, r1.x, -r3.x, r3.w
					    mad o4.z, r1.x, r3.x, r3.w
					    mov o4.xw, r3
					    mul r0.x, r1.w, c32.x
					    mul r0.y, r1.w, c33.x
					    mad r0.xy, r0.z, r2, r0
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.x = (-u_xlat0.x) * 0.5 + 0.5;
					    u_xlat1.w = u_xlat0.x * u_xlat1.x + -0.5;
					    vs_TEXCOORD1.y = (-u_xlat18) * u_xlat1.x + u_xlat1.w;
					    vs_TEXCOORD1.z = u_xlat18 * u_xlat1.x + u_xlat1.w;
					    vs_TEXCOORD1.xw = u_xlat1.xw;
